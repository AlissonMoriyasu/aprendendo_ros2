...
def generate_launch_description():
    ...
    load_robot = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([get_package_share_directory('r2d2_description'),'/launch/robot.launch.py']),
        launch_arguments={
            'rviz_config': [get_package_share_directory('r2d2_spatial'), '/rviz/navigation.rviz'],
        }.items()
...
# -----------------------------------------------------
    ...
    bringup_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'use_sim_time': 'True',
            'params_file': [get_package_share_directory('r2d2_spatial'),'/config/navigation.yaml'],
            'autostart': 'True',
